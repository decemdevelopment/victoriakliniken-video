...
(function () {
   ...
   -------------------------------------------------------------------------------*/
		...
		jQuery(function ($) {
			...
			// Sticky Header
			var stickyHeader = require('./_site/stickyHeader');
			stickyHeader.init();

			// Video Posts Slider
			var videoPostsSlider = require('./_site/video-posts-slider');
			videoPostsSlider.init();
		});
	}, { "./_site/adminHeader": 1, "./_site/menu": 3, "./_site/sliders": 4, "./_site/stickyHeader": 5, "./_site/video-posts-slider": 6 }] }, {}, [7]);
